...
% Moderator's name confirmed as "Muhsin Hussenu" (thesis body/
% acknowledgements spelling), resolving the inconsistency against
% "Muhsin Husseinu" (thesis title page) and "Muhsin Hassanu" (peer paper).
